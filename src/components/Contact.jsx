    ...
    <section id="contact" className="py-20 px-4 scroll-mt-20">
      <div className="container mx-auto max-w-3xl">
        ...
        <div className="flex flex-col sm:flex-row gap-6 flex-wrap">
          <a href="mailto:devratna@example.com" className="flex items-center gap-3 p-4 rounded-xl bg-surface border border-border hover:border-accent/40 transition-colors text-gray-300 hover:text-accent">
            <Mail size={22} className="shrink-0" />
            <span>devratna@example.com</span>
          </a>
          <a href="https://www.linkedin.com/in/dev-ratna-saxena" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 p-4 rounded-xl bg-surface border border-border hover:border-accent/40 transition-colors text-gray-300 hover:text-accent">
